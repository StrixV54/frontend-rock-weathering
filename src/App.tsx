...
function App() {
    ...
    return (
        <>
            <LenisProvider>
                <main ref={containerRef} className="flex relative min-h-screen max-w-screen overflow-hidden">
                    <Logo />
                    <img src="/Corals_Sea_1920x2798.png" className="w-full h-full" />
                    ...
                    <img src="Corals_AddedLight_1920x2798_LIGHTERCOLOR_01.png" className="absolute top-[0] left-[0] w-full h-full coral-sway" />
                    <SpriteImage
                    ...
                    <h1 className="uppercase w-[600px] text-8xl text-center text-white absolute top-[50vh] left-1/2 -translate-x-1/2 -translate-y-1/2">
                        <BlurReveal text="CREATING CORALS FROM CLOUDS" duration={1.5} />
                    </h1>
                    <SpriteImage
                    ...
                    />
                    <img src="/Corals_Background_1920x2798_00000.png" className="absolute top-[8rem] left-0 w-full h-full" />
                    <SpriteImage
                    ...
                    />
                    <CustomTooltip
                        className="absolute top-[73.4rem] right-[8.9rem] -translate-x-1/2 -translate-y-1/2 cursor-pointer !z-[999]"
                    ...
                    <CustomTooltip
                        className="absolute top-[120.4rem] left-[15.9rem] -translate-x-1/2 -translate-y-1/2 cursor-pointer !z-[999]"
                        content="Discover how cloud seeding technology can help restore coral reefs by creating optimal conditions for marine life to flourish."
                    >
                        <img src="/pointer.svg" />
                    </CustomTooltip>
